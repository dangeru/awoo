...
def get_search_results(params, con, offset, session, advanced = false)
  ...
  make_query = ->(where_clause, for_count, first_only_where_clause) do
    ...
    advanced_cols = (advanced and not for_count) ? ", content, parent, ip, date_posted" : ""
    advanced_hack = (advanced and not for_count) ? ", NULL AS content, NULL as parent, NULL as ip, NULL as date_posted" : ""
